...
<s:url id="saveEditPersonalMissionUrl" action="saveEditPersonalMission" />
<s:url id="newPersonalCmissionUrl" action="viewPersonalCmission" />
<div id="container">
			...
			<div class="main-boxes">
				<div class="main-box">
					...
					<div id="viewBox4Mission" class="boxContext">
						<s:form action="saveEditPersonalMission"
							...
							<div class="m30 boxForm f16" id="editBox4intro">
								...
								<div class="tc h50">
									<a
										href="<s:property value="%{newPersonalCmissionUrl}"/>?courseid=<s:property value="courseid"/>&cmissionid=<s:property value="cmission.id"/>">
