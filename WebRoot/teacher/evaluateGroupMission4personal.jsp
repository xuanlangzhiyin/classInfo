...
<s:url id="downloadAttachUrl" action="downloadPersonalFile" />
<s:url id="downloadUnviewable" action="downloadPersonalUnviewable" />
				...
				<div id="evaluateBox">
					<div class="">
						<div class="m10 boxForm f16">
							<s:form action="saveGroupMission4PersonalScore" enctype="multipart/form-data"
								method="post">
								...
								<div class=" h50">
									...
									<p class="fl">
										<span class="mr10 w80 "><s:property
												value="cpersonalmstudentDetailView.name" /> </span> <span><input
								...
								<div id="reportMarkButton" class="h50 f16 tc mt100">
									...
									<a
										href="<s:property value="%{viewGroupMission4personalScoreUrl}"/>?cmissionid=<s:property value="cmissionid"/>&courseid=<s:property value="courseid"/>">
