...
<s:url id="evaluateGroupMissionUrl" action="evaluateGroupMission" />
<div id="container">
									...
									<s:iterator value="cmgroupDetailViews" status="sts">
										<div id="groupBox-<s:property value="id"/>" class="groupBox">
											...
											<div class="groupTitle active">
												...
												<span name="groupName" class="w200">
												...
												<span name="groupMembers" class="w100">
													<s:property value="isSubmitChinese" /> 
												</span>
												<span ><a href="<s:property value="%{evaluateGroupMissionUrl}"/>?courseid=<s:property value="courseid"/>&cmissionid=<s:property 
										value="cmissionid"/>&cmgroupid=<s:property value="id"/>&leaderid=<s:property value="leaderid"/>">评分</a>
												</span>
	...
	<script type="text/javascript" charset="utf-8"
		src="<s:url value="js/teacher/listGroupMissionScore.js"/>"></script>
