...
<div id="container">
	<div class="white w1200 bc">
		<div class="w1060 bc">
			<div class="context">
							...
							<div class="uline "></div>
								...
								<table id="unGroupedTable" class="bc f14" cellspacing="0"
									...
									<tbody>
										...
										<s:iterator value="ungroupedCstudentDetailViews" status="sts">
											<tr id="tr-<s:property value="id"/>">
												...
												<td class="tc"><a class="editFormLink"
													...
													</select> <span class="button_blue_s f12 h25 m5 dlb"
					...
					<div id="groups" class="formTable-context white">
						<div class="listTable w1000 bc cGrey">
							...
							<div class="groupTable m20 bc">
								<h4 class="groupMeta">
									<span class="w50">&nbsp</span><span class="w100">小组编号</span> <span
										class="w400">小组名</span> <span class="w100">队长名</span> <span
										class="w100">小组人数</span> <span>操作</span>
								</h4>
								<div class="cb"></div>
									...
									<s:iterator value="cgroupDetailViews" status="sts">
										<div id="groupBox-<s:property value="id"/>" class="groupBox">
											...
											<div class="groupTitle active">
												<span id="groupCheckbox-<s:property value="id"/>"
													name="groupCheckbox" class="w50 mt5"> <input
													type="checkbox" value="<s:property value="id"/>"> </span>
												<span name="groupIndex" class="w100"><s:property
														value="#sts.count" /> </span> <span name="groupName"
													class="w400"><s:property value="name" /> </span> <span
													name="groupLeaderName" class="w100"><s:property
														value="leaderName" /> </span> <span name="groupMembers"
													class="w100"><s:property value="count" /> </span> <span
													name="groupOperation"> <a href="javascript:void();"
													onclick="cancleAGroup(<s:property value="id"/>)">撤销组</a> </span>
				...
				<div class="cb"></div>
				<!-- <div id="subBox" class="tc h50 f16">
				<input type="button" class="btn blue" value="取&nbsp消"> <input
					type="button" class="btn green" value="提&nbsp交" onclick="submitGrouped(this);">
			</div> 
			-->
				<div id="" class="tc h50 f16">
					<a
						href="tch/viewCourse.action?courseid=<s:property value="courseid"/>&csettingid=<%=request.getParameter("csettingid")%>#cGroup">
	...
	<script type="text/javascript">var courseid=<s:property value="courseid"/>;</script>
	<script type="text/javascript">var csettingid=<s:property value="csettingid"/>;</script>