		...
		<div id="loginMain">
			...
			<div id="loginBox">
				...
				<div class="loginInput">
					<form action=" " method="post" onsubmit=" " autocomplete="off" >

						<input id="username" type="text" class="inputBox active" placeholder="请输入用户名" >
						<input id="password" type="password" class="inputBox" placeholder="请输入密码" >						
